    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      ...
      {movie && (
        <div className="relative h-64 md:h-96 overflow-hidden">
          ...
          <button
            onClick={() => navigate(-1)}
            className="absolute top-6 left-6 md:left-16 z-10 flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition font-medium text-sm"
          >
