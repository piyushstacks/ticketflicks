import logo from './ticketflicks_trcr.png'
...
// Dummy occupied seats mapping - some seats are already booked for each show
export const dummyOccupiedSeats = {
    "68395b407f6329be2bb45bd1": ["A1", "A2", "B3", "C4", "D1"],
    "68395b407f6329be2bb45bd2": ["B1", "B2", "C3"],
    "68395b407f6329be2bb45bd3": ["A5", "A6", "B5", "C1", "C2", "D3"],
    "68395b407f6329be2bb45bd4": ["A1", "D5"],
    "68395b407f6329be2bb45bd5": ["B4", "B5", "C2", "C3", "D1", "D2"],
    "68395b407f6329be2bb45bd6": ["A3", "B2"],
    "68395b407f6329be2bb45bd7": ["C1", "C2", "D4", "D5"],
    "68395b407f6329be2bb45bd8": ["A2", "B3", "B4"],
    "68395b407f6329be2bb45bd9": ["B1", "C5", "D2", "D3"],
    "68395b407f6329be2bb45bda": ["A1", "A2", "A3", "B1", "B2"],
    "68395b407f6329be2bb45bdb": ["C1", "D1"],
    "68395b407f6329be2bb45bdc": ["A4", "A5", "B5", "C3", "D4"],
}
...
export const dummyFeedbackData = [
    {
        "_id": "68396334fb83252d82e17296",
        "user": { "name": "Rahul Kumar" },
        "message": "Amazing movie experience! The seat selection was smooth and the booking process was seamless.",
        "rating": 5,
    ...
    },
    {
        ...
        "message": "Great app! Really loved the seat layout feature. Made it easy to choose the best seats.",
        "rating": 5,
        "createdAt": "2025-06-29T14:15:00.000Z"
    },
    {
        "_id": "68396334fb83252d82e17298",
        "user": { "name": "Arjun Patel" },
        "message": "Good platform for booking tickets. Could improve the payment options a bit.",
        "rating": 4,
        "createdAt": "2025-06-27T09:45:00.000Z"
    },
    {
        "_id": "68396334fb83252d82e17299",
        "user": { "name": "Neha Sharma" },
        "message": "Loved the trailer section! Very helpful to decide which movie to watch.",
        "rating": 5,
        "createdAt": "2025-06-26T16:20:00.000Z"
    },
    {
        "_id": "68396334fb83252d82e172a0",
        "user": { "name": "Vikram Singh" },
        "message": "The app is user-friendly but needs faster loading times for the movie list.",
        "rating": 3,
        "createdAt": "2025-06-25T11:00:00.000Z"
    },
    {
        "_id": "68396334fb83252d82e172a1",
        "user": { "name": "Ananya Gupta" },
        "message": "Excellent service! The entire booking process from movie selection to confirmation was perfect.",
        "rating": 5,
        "createdAt": "2025-06-24T13:30:00.000Z"
    },
    {
        "_id": "68396334fb83252d82e172a2",
        "user": { "name": "Rohan Verma" },
        "message": "Nice app but the show timing options could be more. Limited choices available.",
        "rating": 3,
        "createdAt": "2025-06-23T15:45:00.000Z"
    },
    {
        "_id": "68396334fb83252d82e172a3",
        "user": { "name": "Pooja Desai" },
        "message": "Best movie booking app I've used! Everything is intuitive and works perfectly.",
        "rating": 5,
